...
const PopUpDetail = ({movie, onClose, toggleMyList, movies}) => {
    ...
    ? <FontAwesomeIcon icon="fa-solid fa-heart" style={{ color: "#cc3333" }} className='w-4 p-2 rounded-full bg-light-primary' />
    : <FontAwesomeIcon icon="fa-solid fa-plus" className='w-4 p-2 rounded-full outline-1 outline-light-disabled' />
                ...
                <section className='relative w-full'>
                    ...
                    <section className='absolute bottom-[10%] left-0 flex flex-col w-full px-8 py-4 gap-3 z-3'>
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <Button onClick={() => toggleMyList(movie.id)} variant='clear'>{myListIcon}</Button>
