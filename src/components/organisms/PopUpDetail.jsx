...
import Movies from '../../allFilms.json'
...
const PopUpDetail = ({movie, onClose}) => {
    ...
    return (
        <div className='flex justify-center items-center w-full h-full bg-page-header/80'>
            <div className='relative flex flex-col justify-center items-center w-[70%] lg:w-[50%] rounded-xl bg-page-header text-md text-light-primary drop-shadow-xl drop-shadow-light-primary/10'>
                {/* Cover Section */}
                <section className='relative w-full'>
                    ...
                    {/* Exit Button */}
                    <Button onClick={onClose} variant='clear' className='absolute top-5 right-5'>
                        <FontAwesomeIcon icon="fa-solid fa-xmark" className='w-4 p-1 rounded-full bg-page-header/80'/>
                    </Button>
                    ...
                    <section className='absolute bottom-[10%] left-0 flex flex-col w-full px-8 py-4 gap-3 z-3'>
                        ...
                        <div className='flex items-center gap-4'>
                            <Button className='py-1 px-3 rounded-full  bg-primary-300'>Mulai</Button>
                            <Button onClick={handleClick} variant='clear'>{myList}</Button>
                            <Button variant='clear' className='absolute right-8'><FontAwesomeIcon icon="fa-solid fa-volume-xmark" className='w-4 p-2 rounded-full outline-1 outline-light-disabled'/></Button>
                        </div>
                    </section>
                </section>
                ...
                <section className='flex flex-col w-full px-8 py-4 gap-3 lg:gap-6'>
                    ...
                    <div className='flex w-full gap-8'>
                        <div className='flex flex-col w-[55%] gap-3 text-sm'>
                            <div className='flex gap-4 text-light-secondary'>
                                <div>2023</div>
                                <div>2j 29m</div>
                                <div className='rounded-sm px-3 outline-1 outline-light-primary text-light-primary'>{movie.age_rating}</div>
                            </div>
                            <div>
                                <p>
                        ...
                        <div className='grid grid-cols-[minmax(60px,100px)_10px_1fr] w-[45%] gap-y-2 text-sm text-light-secondary'>
                            ...
                            <span className="font-medium text-light-primary">Pembuat Film</span>
                            <span className="text-light-primary">:</span>
                    ...
                    <div className='flex  flex-col gap-4'>
                        ...
                        <div className='relative'>
                            <div className='relative flex flex-nowrap scrollbar-hide gap-4 text-light-primary'>
                                ...
                                <div key={movie.id} className="relative group shrink grow">
                                    <Card movie={movie} />

                                    <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 group-hover:scale-120 transition-opacity duration-300 z-19'>
