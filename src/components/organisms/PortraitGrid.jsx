...
const PortraitGrid = ({title = 'Movie List', filterKey = 'watched', onShowDetail, itemsPerPage = 4}) => {
  ...
  return (
    <section className='flex flex-col gap-3 mb-5'>
      ...
      <div className='relative'>
        ...
        <div className={`relative flex flex-nowrap sm:grid ${gridColsMap[itemsPerPage] || 'md:grid-cols-4'} overflow-x-auto overflow-y-clip scrollbar-hide sm:overflow-visible gap-4 text-light-primary`}>
