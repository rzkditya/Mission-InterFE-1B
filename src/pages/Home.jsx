...
const Home = () => {
  ...
  return (
    <>
      <Header/>
      <Main>
        <LandscapeGrid onShowDetail={handleShowDetail} movieList={movieList} toggleMyList={toggleMyList} itemsPerPage={4}/>
        <PortraitGrid title='Top Rating Film dan Series Hari Ini' filterKey='isTopRated' onShowDetail={handleShowDetail} movieList={movieList} toggleMyList={toggleMyList} itemsPerPage={5}/>
        <PortraitGrid title='Film Trending' filterKey='isTrending' onShowDetail={handleShowDetail} movieList={movieList} toggleMyList={toggleMyList} itemsPerPage={5}/>
        <PortraitGrid title='Rilis Baru' filterKey='isNewRelease' onShowDetail={handleShowDetail} movieList={movieList} toggleMyList={toggleMyList} itemsPerPage={5}/>
      </Main>
      <Footer/>
